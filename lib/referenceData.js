...
export const distressCalls = {
  mayday: {
    ...
    steps: [
      ...
      'Send DSC Distress alert (hold button 3-5 seconds, if equipped with DSC)',
      'Switch to Channel 16 (or 2182 kHz MF)',
      'Transmit Mayday call and message as one continuous transmission: "Mayday [3x], this is [vessel name] [3x], Mayday [1x], [vessel name], position, nature of distress, persons on board, vessel description, assistance required, OVER"',
